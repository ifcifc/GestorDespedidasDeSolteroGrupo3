...
namespace GestorEventos.Servicios.Entidades
{
    public class EventoServicio : Entidad
    {
        ...
        public override string SQL_GetAll() => "SELECT * FROM EventosServicios WHERE Borrado=0";
        public override string SQL_GetByID() => "SELECT * FROM EventosServicios WHERE Borrado=0 AND IdEventoServicio={0}";
