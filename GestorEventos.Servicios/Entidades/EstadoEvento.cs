...
namespace GestorEventos.Servicios.Entidades
{
    public class EstadoEvento : Entidad
    {
        ...
        public override string SQL_GetAll() => "SELECT * FROM EstadosEventos WHERE Borrado=0";
        public override string SQL_GetByID() => "SELECT * FROM EstadosEventos WHERE Borrado=0 AND IdEstadoEvento={0}";
